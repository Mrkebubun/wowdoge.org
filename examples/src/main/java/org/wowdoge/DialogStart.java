...
public class DialogStart extends JDialog {
	 ...
	 */
	public DialogStart() {
		setTitle("Wow - Doge Wallet - Quick Start");
		...
		btnNewWallet.addComponentListener(new ComponentAdapter() {
			...
			public void componentResized(ComponentEvent arg0) {
				...
				btnNewWallet.setIcon(new ImageIcon (new ImageIcon(Wow.class.getResource("/org/wowdoge/doge.png")).getImage().getScaledInstance(min0, min0, Image.SCALE_SMOOTH)));
		...
		btnOpenExistingWallet.addComponentListener(new ComponentAdapter() {
			...
			public void componentResized(ComponentEvent e) {
				...
				int min0 = (int) (min * 0.85);
				//System.out.println("RESIZED");
				btnOpenExistingWallet.setIcon(new ImageIcon (new ImageIcon(Wow.class.getResource("/org/wowdoge/doge.png")).getImage().getScaledInstance(min0, min0, Image.SCALE_SMOOTH)));
